...
Use fakes at adapter boundaries where possible. Real Telegram, Playwright, BGE Small, and sqlite-vec integrations should stay optional so the core suite remains fast and local.
